...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <h2 class="text-center" style="font-family: Quicksand, sans-serif;">Perpustakaan SMAN 27 Bandung</h2>
            <p class="text-center">Alamat : Jl. Utsman Bin Affan No.1, Rancanumpang, Kec. Gedebage, Kota Bandung, Jawa Barat 40295</p>

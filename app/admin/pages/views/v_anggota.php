                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="kelas">
                            ...
                            <!-- XI -->
                            <option disabled>------------------------------------------</option>
                            <option value="XII - A">XI - A</option>
                            <option value="XII - B">XI - B</option>
                            <option value="XII - C">XI - C</option>
                            <option value="XII - D">XI - D</option>
                            <option value="XII - E">XI - E</option>
                            <option value="XII - F">XI - F</option>
                            <option value="XII - G">XI - G</option>
                            <option value="XII - H">XI - H</option>
                        </select>
                    </div>
                    <div class="form-group">
